...
export const NAV_MODULES: NavModule[] = [
  ...
  { slug: 'digital-twin', label: 'Process Digital Twin', href: '/digital-twin', icon: '🧬', phase: 3, implemented: true, requires: 'interview.review', description: 'Structured, visual representation of each discovered process.' },
  { slug: 'process-maps', label: 'Process Maps', href: '/process-maps', icon: '🗺️', phase: 3, implemented: true, requires: 'interview.review', description: 'Flowcharts, swimlanes and system interaction maps.' },
  { slug: 'sop-library', label: 'SOP Library', href: '/sop-library', icon: '📋', phase: 3, implemented: true, requires: 'interview.review', description: 'Generated SOPs with version control and approval status.' },
  { slug: 'knowledge-base', label: 'Knowledge Base', href: '/knowledge-base', icon: '🧠', phase: 3, implemented: true, requires: 'interview.review', description: 'Structured, searchable business knowledge.' },
